class bigbluebutton::install_meeting(
    ...
    exec { 'copy-cert-ssl':
        ...
        cwd =>"${user_home}/dev/bigbluebutton/bigbluebutton-meeting/certs/",
    }
    ...
    exec { 'copy-sip-nginx':
        ...
        cwd => "${user_home}/dev/bigbluebutton/bigbluebutton-meeting",
    }
    ...
    exec { 'configure-bbb-api-conf-https':
        ...
        cwd => "${user_home}/dev/bigbluebutton/bigbluebutton-meeting/src/main/webapp",
    }
